...
int main(int argc, char* argv[]) 
{
    ...
    if( argc != 2)
    {
        printf("DIR_M Use Error : processname IP Port 'Ex : DIR_B 127.0.0.1' ");
        exit(0);
    }
    ...
    if (mq_key == -1)
    {
        printf("DIR_M Message Get Failed!\n");
        return -1;
    }
    ...
    while(1)
    {
        ...
        { 
            printf("DIR_M Message Receiving Finished!\n");
            exit(0);
        }
